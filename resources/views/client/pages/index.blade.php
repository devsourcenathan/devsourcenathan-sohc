            ...
            <div class="carousel-item active">
                ...
                <div class="carousel-caption d-flex flex-column align-items-center justify-content-center">
                    <div class="p-3" style="max-width: 700px">
                        ...
                        <a href="/lodgment" class="btn btn-primary py-md-3 px-md-5 me-3 animated slideInLeft">Nos logements</a>
            ...
            <div class="carousel-item">
                ...
                <div class="carousel-caption d-flex flex-column align-items-center justify-content-center">
                    <div class="p-3" style="max-width: 700px">
                        ...
                        <a href="/lodgment" class="btn btn-primary py-md-3 px-md-5 me-3 animated slideInLeft">Decouvrir</a>
                        {{-- <a href="" class="btn btn-light py-md-3 px-md-5 animated slideInRight">Book A Room</a> --}}
                    </div>
                </div>
            </div>
...
<div class="container-xxl py-5">
    <div class="container">
        ...
        <div class="row g-4">
            <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                <div class="room-item shadow rounded overflow-hidden">
                    <div class="position-relative">
                        ...
                        <small class="position-absolute start-0 top-100 translate-middle-y bg-primary text-white rounded py-1 px-3 ms-4">100.000F/Mois</small>
                    </div>
                    <div class="p-4 mt-2">
            ...
            <a href="/lodgment" class="btn btn-primary py-md-3 px-md-5 me-3 animated slideInLeft">Voir Plus de logements</a>
        </div>
    </div>
</div>
<!-- Room End -->
